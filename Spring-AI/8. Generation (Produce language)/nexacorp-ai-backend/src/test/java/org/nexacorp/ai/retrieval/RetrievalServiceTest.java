...
public class RetrievalServiceTest {
    ...
    @Test
    void retrieve_test(){
        //RetrievalResult result = retrievalService.retrieve(("I need to know about NexaCorp's leave policy"));
        //RetrievalResult result = retrievalService.retrieve(("Explain Nexacorp authentication flow"));
        RetrievalResult result = retrievalService.retrieve(("What security practices does Nexacorp follow?"));
